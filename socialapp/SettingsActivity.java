...
public class SettingsActivity extends AppCompatActivity {
    ...
    TextView showblockusersTv,updateEmailtv,showviewedprofile;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        updateEmailtv = findViewById(R.id.updateemailtvv);
        showviewedprofile = findViewById(R.id.whoviewedrprofile);
        ...
        showviewedprofile.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {

                Intent intent = new Intent(SettingsActivity.this,ProfileViewed.class);
                startActivity(intent);
        ...
        updateEmailtv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(SettingsActivity.this,UpdateEmail.class);
                startActivity(intent);
