...
public class ShowUser extends AppCompatActivity {
    ...
    String url,name,p,userid,usertoken;
    RequestMember requestMember;
    String name_result;
    String uidreq,namereq,urlreq,professionreq;
    All_UserMmber all_userMmber;
    Button sendmessage;
    int postNo ;
    FirebaseFirestore db = FirebaseFirestore.getInstance();
    DocumentReference documentReference,documentReference1;

    DatabaseReference checkVideocallRef,viewedprofileref;
    String senderuid;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        all_userMmber = new All_UserMmber();
        ...
        viewedprofileref = database.getReference("Viewed Profile");
    ...
    private void saveprofile(String name, String url) {
        ...
        all_userMmber.setName(name);
        all_userMmber.setUrl(url);
        all_userMmber.setUid(currentuid);

        viewedprofileref.child(currentuid).setValue(all_userMmber);
